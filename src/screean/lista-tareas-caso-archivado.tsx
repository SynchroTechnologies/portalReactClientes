...
const ListaTareasCasoArchivado: React.FC<Props> = ({ casoId }) => {
  ...
  const renderListTaskHumanUserId = listTaskHumanUserId.map((list) => (
    <div className="container">
      <div className="row shadow p-2 mb-3 bg-white rounded">
        <div className="col-1">
          <div> Id tarea </div>
        ...
        <div className="col-2">
          {" "}
          <div>Creada</div>
          <div>{formatearFecha(list.reached_state_date)} </div>
        </div>
        <div className="col-2">
          {" "}
          <div>Tomada</div>
          <div>{formatearFecha(list.assigned_date)} </div>
        </div>
        <div className="col-2">
          {" "}
          <div>Ultima actualizacion</div>
  ...
  const renderListTaskHumanMyUser = listTaskHumanMyUser.map((listM) => (
    <div className="container">
      <div className="row shadow p-2 mb-3 bg-white rounded">
        <div className="col-1">
          <div> Id tarea </div>
        ...
        <div className="col-2">
          {" "}
          <div>Creada</div>
          <div>{formatearFecha(listM.reached_state_date)} </div>
        </div>
        <div className="col-2">
          {" "}
          <div>Tomada</div>
          <div>{formatearFecha(listM.assigned_date)} </div>
        </div>
        <div className="col-2">
          {" "}
          <div>Ultima actualizacion</div>
  ...
  const renderListTaskHumanCompleteUser = listTaskHumanCompleteUser.map(
    (listc) => (
      <div className="container">
        <div className="row shadow p-2 mb-3 bg-white rounded">
          <div className="col-1">
          ...
          <div className="col-2">
            {" "}
            <div>Creada</div>
            <div>{formatearFecha(listc.reached_state_date)} </div>
          </div>
          <div className="col-2">
            {" "}
            <div>Tomada</div>
            <div>{formatearFecha(listc.assigned_date)} </div>
          </div>
          <div className="col-2">
            {" "}
            <div>Ultima actualizacion</div>
      ...
      >
        <div className="row">
          ...
          <div className="column">
            ...
            {renderListTaskHumanCompleteUser}
          </div>
        </div>
      </div>
    </div>
